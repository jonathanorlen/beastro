...
<html>
  <head>
    ...
    <!--external css-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'componenet/template/assets/js/bootstrap-datepicker/css/datepicker.css'?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'component/template/assets/js/bootstrap-daterangepicker/daterangepicker.css'?>" />
...
<!--custom checkbox & radio-->
    ...
    <script type="text/css" src="<?php echo base_url() .'component/template/assets/js/bootstrap-datepicker/js/bootstrap-datepicker.js' ?>"></script>
    <script type="text/css" src="<?php echo base_url().'component/template/assets/js/bootstrap-daterangepicker/date.js'?>"></script>
    <script type="text/css" src="<?php echo base_url().'component/template/assets/js/bootstrap-daterangepicker/daterangepicker.js'?>"></script>
    
    <script type="text/css" src="<?php echo base_url().'component/template/assets/js/bootstrap-inputmask/bootstrap-inputmask.min.js' ?>"></script>
    
    
    <script src="<?php echo base_url().'component/template/assets/js/form-component.js'?>"></script>    
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Astro</b></a>
            <!--logo end-->
